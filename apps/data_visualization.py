...
class DataVisualizationApp(tk.Toplevel):
    def __init__(self, selected_team=None):
        ...
        self.bip_scatter_frame.grid(row=1, column=0, sticky='nsew')

        krate_df = generate_k_rate_df()
        self.krate_scatter_frame = DataVisualScatterFrame3D(self.main_frame, df=krate_df)
        self.krate_scatter_frame.grid(row=1, column=1, sticky='nsew')
