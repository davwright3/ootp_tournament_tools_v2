...
def calc_ratings(
    ...
    if pitcher_weights is None:
        ...
        df['PitvL'] = ((df['Stuff vL'] * pitcher_weights['weight_stuff_vL']) +
                         ...
                         (df['Control vL'] * pitcher_weights['weight_control_vL'])
                         )
    ...
    if defense_weights is None:
        ...
        df['Catch Def'] = ((df['CatcherAbil'] * defense_weights['weight_catch_abil']) +
                           (df['CatcherFrame'] * defense_weights['weight_catch_frame']) +
                           (df['Catcher Arm'] * defense_weights['weight_catch_arm'])
                           )
        df['IF Def'] = ((df['Infield Range'] * defense_weights['weight_infield_range']) +
        ...
        df['OF Def'] = ((df['OF Range'] * defense_weights['weight_outfield_range']) +
