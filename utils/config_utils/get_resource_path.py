...
def get_resource_path(relative_path):
    ...
    Checks if system is frozen (PyInstaller environment), and if so, returns the
    base _MEIPASS root for resource discovery.
    If not frozen (development environment), the absolute path of the project is
    joined with the relative path of the file.
