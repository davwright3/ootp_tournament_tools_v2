...
def select_target_file(target_var):
    ...
    This module allows the user to set the target of their OOTP Baseball Perfect
    Team card list dump from the card shop in game.
    This is a requirement for the statistics portion of the program to function.
