...
class PlayerCardPitcherRatingsFrame(tk.Frame):
    def __init__(self, parent, df=None):
        ...
        self.label = tk.Label(self, text="Pitcher Ratings", font=fonts.frame_title_font)
        ...
        self.pbabip_label = tk.Label(self, text="pBABIP", font=fonts.basic_font)
        self.pbabip_label.grid(row=4, column=0, sticky='nsew')

        self.control_label = tk.Label(self, text="Control", font=fonts.basic_font)
        ...
        # Rating labels
        self.stuff_overall_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=df.iloc[0]['Stuff'])
        self.stuff_overall_rating_label.grid(row=2, column=1, sticky='nsew')

        self.stuff_vl_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=df.iloc[0]['Stuff vL'])
        self.stuff_vl_rating_label.grid(row=2, column=2, sticky='nsew')

        self.stuff_vr_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=df.iloc[0]['Stuff vR'])
        self.stuff_vr_rating_label.grid(row=2, column=3, sticky='nsew')

        self.phr_overall_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=df.iloc[0]['pHR'])
        self.phr_overall_rating_label.grid(row=3, column=1, sticky='nsew')

        self.phr_vl_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=df.iloc[0]['pHR vL'])
        self.phr_vl_rating_label.grid(row=3, column=2, sticky='nsew')

        self.phr_vr_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=df.iloc[0]['pHR vR'])
        self.phr_vr_rating_label.grid(row=3, column=3, sticky='nsew')

        self.pbabip_overall_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=df.iloc[0]['pBABIP'])
        self.pbabip_overall_rating_label.grid(row=4, column=1, sticky='nsew')

        self.pbabib_vl_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=df.iloc[0]['pBABIP vL'])
        self.pbabib_vl_rating_label.grid(row=4, column=2, sticky='nsew')

        self.pbabip_vr_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=df.iloc[0]['pBABIP vR'])
        self.pbabip_vr_rating_label.grid(row=4, column=3, sticky='nsew')

        self.control_overall_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=df.iloc[0]['Control'])
        self.control_overall_rating_label.grid(row=5, column=1, sticky='nsew')

        self.control_vl_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=df.iloc[0]['Control vL'])
        self.control_vl_rating_label.grid(row=5, column=2, sticky='nsew')

        self.control_vr_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=df.iloc[0]['Control vR'])
