...
class BaserunningProfileFrame(tk.Frame):
    def __init__(self, parent, df):
        ...
        row = 1
        self.label = tk.Label(self, text="Baserunning Profile", font=fonts.frame_title_font)
        self.label.grid(row=row, column=0, sticky='nsew', columnspan=2)
        row += 1

        self.speed_label = tk.Label(self, text="Speed", font=fonts.basic_font)
        ...
        self.steal_rate_label = tk.Label(self, text="Steal Rate", font=fonts.basic_font)
        ...
        self.stealing_label = tk.Label(self, text="Stealing", font=fonts.basic_font)
        ...
        self.baserunning_label = tk.Label(self, text="Baserunning", font=fonts.basic_font)
