...
class MinMaxFrame(tk.Frame):
    def __init__(self, parent):
        ...
        self.label = tk.Label(self, text="Min and Max Ratings", justify='center')
        ...
        self.min_rating = tk.Entry(self, textvariable=self.min_rating, width=10)
        ...
        self.max_rating = tk.Entry(self, textvariable=self.max_rating, width=10)
