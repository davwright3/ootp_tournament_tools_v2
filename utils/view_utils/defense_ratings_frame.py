...
class DefenseRatingsFrame(tk.Frame):
    def __init__(self, parent, df):
        ...
        # Catcher Section
        self.catcher_label = tk.Label(self, text='Catcher', font=fonts.basic_font_bold)
        self.catcher_label.grid(row=1, column=0)

        self.catch_abil_label = tk.Label(self, text='Abil', font= fonts.basic_font_bold)
        self.catch_abil_label.grid(row=0, column=1)

        self.catch_frame_label = tk.Label(self, text='Frame', font=fonts.basic_font_bold)
        self.catch_frame_label.grid(row=0, column=2)

        self.catch_arm_label = tk.Label(self, text='Arm', font=fonts.basic_font_bold)
        self.catch_arm_label.grid(row=0, column=3)

        # Positions Section
        self.range_label = tk.Label(self, text='Range', font=fonts.basic_font_bold)
        self.range_label.grid(row=2, column=1)

        self.error_label = tk.Label(self, text='Error', font=fonts.basic_font_bold)
        self.error_label.grid(row=2, column=2)

        self.arm_label = tk.Label(self, text='Arm', font=fonts.basic_font_bold)
        self.arm_label.grid(row=2, column=3)

        self.turn_dp_label = tk.Label(self, text='DP', font=fonts.basic_font_bold)
        self.turn_dp_label.grid(row=2, column=4)

        self.infield_label = tk.Label(self, text='Infield', font=fonts.basic_font_bold)
        self.infield_label.grid(row=3, column=0)

        self.outfield_label = tk.Label(self, text='Outfield', font=fonts.basic_font_bold)
        self.outfield_label.grid(row=4, column=0)

        # Ratings
        self.catch_abil_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=catch_abil)
        self.catch_abil_rating_label.grid(row=1, column=1, sticky='ew')

        self.catch_frame_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=catch_frame)
        self.catch_frame_rating_label.grid(row=1, column=2, sticky='ew')

        self.catch_arm_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=catch_arm)
        self.catch_arm_rating_label.grid(row=1, column=3, sticky='ew')

        self.infield_range_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=if_range)
        self.infield_range_rating_label.grid(row=3, column=1, sticky='ew')

        self.infield_error_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=if_error)
        self.infield_error_rating_label.grid(row=3, column=2, sticky='ew')

        self.infield_arm_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=if_arm)
        self.infield_arm_rating_label.grid(row=3, column=3, sticky='ew')

        self.turn_dp_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=turn_dp)
        self.turn_dp_rating_label.grid(row=3, column=4, sticky='ew')

        self.outfield_range_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=of_range)
        self.outfield_range_rating_label.grid(row=4, column=1, sticky='ew')

        self.outfield_error_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=of_error)
        self.outfield_error_rating_label.grid(row=4, column=2, sticky='ew')

        self.outfield_arm_rating_label = ColorRatingLabel(self, font=fonts.basic_font, rating=of_arm)
