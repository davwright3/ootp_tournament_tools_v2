...
from utils.view_utils.eligible_defense_positions_frame import EligibleDefensePositionsFrame
...
class PlayerCardDefenseRatingsFrame(tk.Frame):
    def __init__(self, parent, df):
        ...
        self.label = tk.Label(self, text='Defense Ratings', font=fonts.frame_title_font)
        ...
        ttk.Separator(self, orient='vertical').grid(row=1, column=1, sticky='nsew')
