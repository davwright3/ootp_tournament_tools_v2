...
class BatterRattingFrame(tk.Frame):
    def __init__(self, parent, df=None):
        ...
        # Set outer labels
        self.label = tk.Label(self, text='Batter Ratings', font=self.font)
        self.label.grid(column=0, row=0, columnspan=4)

        self.overall_label = tk.Label(self, text='OA', font=self.font)
        self.overall_label.grid(column=1, row=1)

        self.vs_left_label = tk.Label(self, text='vL', font=self.font)
        self.vs_left_label.grid(column=2, row=1)

        self.vs_right_label = tk.Label(self, text='vR', font=self.font)
        self.vs_right_label.grid(column=3, row=1)

        self.babip_label = tk.Label(self, text='BABIP', font=self.font)
        self.babip_label.grid(column=0, row=2)

        self.avoid_k_label = tk.Label(self, text='AvoidK', font=self.font)
        self.avoid_k_label.grid(column=0, row=3)

        self.gap_label = tk.Label(self, text='Gap', font=self.font)
        self.gap_label.grid(column=0, row=4)

        self.power_label = tk.Label(self, text='Power', font=self.font)
        self.power_label.grid(column=0, row=5)

        self.eye_label = tk.Label(self, text='Eye', font=self.font)
